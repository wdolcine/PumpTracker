...
Features
Splash Screen: Displays the app logo briefly during the startup.
User Authentication: Login and registration options using email or third-party providers (Google, Apple).
...
Tab Navigation: Intuitive bottom navigation to switch between Home, PumpList, and Profile screens.
